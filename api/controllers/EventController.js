...
module.exports = {
  ...
  create: function (req, res, next) {
    if (req.method != 'POST') {
      ...
      eventObj.startOn = new Date(moment(req.param('startOn')).zone(0).format());
      eventObj.endOn = new Date(moment(req.param('endOn')).zone(0).format());
      eventObj.registrationStartOn = new Date(moment(req.param('registrationStartOn')).zone(0).format());
      eventObj.registrationEndOn = new Date(moment(req.param('registrationEndOn')).zone(0).format());
